c
c cant just have the main calling the function because it wont profule
   


c use the original transit base case
c
...
c
      ...
      integer :: minbin, nbmax, kmi, kma, kkmi, nb1, nbkma, i, jf, j
      integer :: jnb, k, kk, nb2, jn1, jn2
